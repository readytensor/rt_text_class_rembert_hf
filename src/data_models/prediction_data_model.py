...
def get_predictions_validator(schema: TextClassificationSchema) -> BaseModel:
    """
...
def validate_predictions(
    predictions: pd.DataFrame, data_schema: TextClassificationSchema
) -> pd.DataFrame:
    """
...
if __name__ == "__main__":
    ...
    schema_provider = TextClassificationSchema(schema_dict)
