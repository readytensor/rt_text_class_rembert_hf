...
def load_hf_dataset(
    ...
    Returns:
    - Tuple[Dataset, RemBertTokenizer]: A tuple containing the tokenized dataset and the tokenizer.
    """
    ...
    tokenizer_path = tokenizer_dir_path if tokenizer_dir_path else "google/rembert"
    tokenizer = RemBertTokenizer.from_pretrained(tokenizer_path)
